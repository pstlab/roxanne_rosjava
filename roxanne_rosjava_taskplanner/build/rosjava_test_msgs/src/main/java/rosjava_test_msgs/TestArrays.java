...
public interface TestArrays extends org.ros.internal.message.Message {
  static final java.lang.String _TYPE = "rosjava_test_msgs/TestArrays";
  ...
  java.util.List<rosjava_test_msgs.TestString> getTestStringArray();
  void setTestStringArray(java.util.List<rosjava_test_msgs.TestString> value);
}

package com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3;
...
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.domain.component.resource.discrete.DiscreteResource;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.domain.component.resource.discrete.RequirementResourceValue;
...
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.microkernel.lang.ex.DomainComponentNotFoundException;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.microkernel.lang.ex.SynchronizationCycleException;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.microkernel.lang.problem.Problem;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.microkernel.lang.problem.ProblemFact;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.microkernel.lang.problem.ProblemFluent;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.microkernel.lang.problem.ProblemGoal;
...
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.DomainCompiler;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.DomainCompilerType;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLComponent;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLComponentDecision;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLComponentType;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLConsumableResourceComponentDecision;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLConsumableResourceComponentType;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLDomain;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLEnumerationParameterConstraint;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLEnumerationParameterType;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLInstantiatedComponentDecision;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLNumericParameterConstraint;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLNumericParameterType;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLParameterConstraint;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLParameterType;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLProblem;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLRenewableResourceComponentDecision;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLRenewableResourceComponentType;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLSimpleGroundStateVariableComponentDecision;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLSingletonStateVariableComponentDecision;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLSingletonStateVariableComponentDecisionType;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLSingletonStateVariableComponentType;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLSingletonStateVariableTransitionConstraint;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLSynchronization;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLTemporalRelation;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLTemporalRelationType;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLTimeline;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.DDLTimelineSynchronization;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.ddl3Lexer;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.compiler.ddl.v3.parser.ddl3Parser;
...
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.domain.component.pdb.SynchronizationRule;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.domain.component.pdb.TokenVariable;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.domain.component.sv.StateVariable;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.domain.component.sv.StateVariableValue;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.domain.component.sv.Transition;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.parameter.lang.EnumerationParameterDomain;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.parameter.lang.NumericParameterDomain;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.parameter.lang.ParameterDomain;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.parameter.lang.ParameterDomainType;
		...
		for (DDLParameterConstraint ddlRel : this.ddl_problem.getParameterConstraints()) {
			...
			switch (ddlRel.getConstraintType()) {
				...
				case ENUMERATION : {
					...
					// check relation type
					if (ddlpc.getEnumerationConstraintType().equals(DDLEnumerationParameterConstraint.DDLEnumerationParameterConstraintType.NEQ)) {
						// FIXME : <----- IMPLEMENTARE
				...
				case NUMERIC : {
					...
					if (ddlpc.getRightVariables() != null && ddlpc.getRightVariables().get(0) != null) {
						...
						// check relation type
						if (ddlpc.getNumericConstraintType().equals(DDLNumericParameterConstraint.DDLNumericParameterConstraintType.NEQ)) {
							// FIXME : <<<<<<<<------ IMPLEMENTARE
							throw new RuntimeException("Unknown numeric constraint type " + ddlpc.getNumericConstraintType());
						}
	...
	private void addStateVariable(PlanDataBase pdb, DDLComponent ddlComponent) 
	{
		...
		for (DDLTimeline ddlTimeline : ddlComponent.getTimelines()) 
		{
			...
			for (DDLSingletonStateVariableTransitionConstraint ddlTransition : ddlComponentType.getTransitionConstraints()) 
			{
				...
				Map<String, Map<String, DDLNumericParameterConstraint.DDLNumericParameterConstraintType>> labels2constraint = new HashMap<>();
						...
						case NUMERIC : 
						{
							...
							if (numConstraint.isBinary()) {
								...
								if (!labels2constraint.containsKey(referenceLabel)) {
									labels2constraint.put(referenceLabel, new HashMap<String, DDLNumericParameterConstraint.DDLNumericParameterConstraintType>());
								}
								...
								for (String targetLabel : numConstraint.getRightVariables()) {
									...
									if (!labels2constraint.containsKey(targetLabel)) {
										labels2constraint.put(targetLabel, new HashMap<String, DDLNumericParameterConstraint.DDLNumericParameterConstraintType>());
									}
				...
				for (DDLSingletonStateVariableComponentDecision target : ddlTransition.getTo()) 
				{
					...
					for (String referenceParName : source.getParameterNames()) 
					{
						...
						for (String targetParName : target.getParameterNames()) 
						{
							...
							{
								// get parameter
								DDLNumericParameterConstraint.DDLNumericParameterConstraintType ddlConsType = labels2constraint.get(referenceParName).get(targetParName);

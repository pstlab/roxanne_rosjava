...
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.time.tn.ex.IntervalDisjunctionException;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.time.tn.ex.NotCompatibleConstraintsFoundException;
...
public final class SimpleTemporalNetworkWithUncertainty extends TemporalNetwork 
{
	...
	public List<TimePointDistanceConstraint> getConstraints(TimePoint tp) 
	{
		...
		cons.put(tp, new HashMap<TimePoint, TimePointDistanceConstraint>());

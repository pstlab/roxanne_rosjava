...
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.utils.view.component.ComponentView;
import com.github.roxanne_rosjava.roxanne_rosjava_core.ai.framework.utils.view.component.gantt.GanttComponentView;
...
public abstract class DomainComponent extends FrameworkObject
{
	...
	protected DomainComponent(String name, DomainComponentType type) {
		...
		for (PlanElementStatus status : PlanElementStatus.values()) {
			this.decisions.put(status, new HashSet<Decision>());
		}
